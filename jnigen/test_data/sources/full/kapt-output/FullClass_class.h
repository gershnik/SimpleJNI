...
public:
    ...
    void func1(JNIEnv * env, const smjni::auto_java_ref<jFullClass> & self, jdouble d, jfloat f) const
    ...
    void setRegularMutablePropWithSetter(JNIEnv * env, const smjni::auto_java_ref<jFullClass> & self, const smjni::auto_java_ref<jstring> & p0) const
        { m_setRegularMutablePropWithSetter(env, self, p0); }
    ...
    void setRegularMutablePropWithGetterAndSetter(JNIEnv * env, const smjni::auto_java_ref<jFullClass> & self, const smjni::auto_java_ref<jstring> & p0) const
        { m_setRegularMutablePropWithGetterAndSetter(env, self, p0); }
    ...
    void setRegularMutablePropWithOnlySetter(JNIEnv * env, const smjni::auto_java_ref<jFullClass> & self, const smjni::auto_java_ref<jstring> & p0) const
        { m_setRegularMutablePropWithOnlySetter(env, self, p0); }
    ...
    void setRegularMutablePropWithOnlyGetterAndSetter(JNIEnv * env, const smjni::auto_java_ref<jFullClass> & self, const smjni::auto_java_ref<jstring> & p0) const
        { m_setRegularMutablePropWithOnlyGetterAndSetter(env, self, p0); }
private:
