...
public:
    ...
    void extended(JNIEnv * env, const smjni::auto_java_ref<jExtension> & self, const smjni::auto_java_ref<jInner> & receiver) const
        { m_extended(env, self, receiver); }
private:
    static void JNICALL nativeExtended(JNIEnv *, jExtension, jInner receiver);
